...
import com.mycompany.mars.data.Field333;
...
public class ValidatorField333 extends TransferValidator<Field333>{
    
    @Override
    public boolean validate(ValidatorContext context, Field333 field333) {
        if (field333 != null) {
            ComplexResult ret = FluentValidator.checkAll().failOver()
                    .putAttribute2Context("fieldName", "333")
                    .on(field333.getI1(), new ValidatorI1())
                    .on(field333.getI2(), new ValidatorI2())
